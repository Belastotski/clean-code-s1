...
var taskInput=document.querySelector(".controller__input");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".controller__tasks-list_incomplete");//ul of #incomplete-tasks
var completedTasksHolder=document.querySelector(".controller__tasks-list_complete");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="task__button-edit wrapper-controller_button";

    // deleteButton.innerText="Delete";
    deleteButton.className="task__button-delete wrapper-controller_button";
